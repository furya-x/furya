...
type BondReportProposal struct {
	...
	Action   BondAction `protobuf:"varint,4,opt,name=action,proto3,enum=katana.katana.ledger.BondAction" json:"action,omitempty"`
...
type ExecuteBondProposal struct {
	...
	State    LiquidityBondState                     `protobuf:"varint,8,opt,name=state,proto3,enum=katana.katana.ledger.LiquidityBondState" json:"state,omitempty"`
}
...
func init() {
	proto.RegisterType((*SetChainEraProposal)(nil), "katana.katana.ledger.SetChainEraProposal")
	proto.RegisterType((*BondReportProposal)(nil), "katana.katana.ledger.BondReportProposal")
	proto.RegisterType((*ActiveReportProposal)(nil), "katana.katana.ledger.ActiveReportProposal")
	proto.RegisterType((*TransferReportProposal)(nil), "katana.katana.ledger.TransferReportProposal")
	proto.RegisterType((*ExecuteBondProposal)(nil), "katana.katana.ledger.ExecuteBondProposal")
	proto.RegisterType((*InterchainTxProposal)(nil), "katana.katana.ledger.InterchainTxProposal")
}
