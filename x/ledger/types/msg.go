...
import (
	...
	utils "github.com/warmage-sports/katana/utils"
)
...
func NewMsgSetRParams(creator string, denom string, gasPrice string, eraSeconds uint32, offset int32, bondingDuration uint32, leastBond string) *MsgSetRParams {
