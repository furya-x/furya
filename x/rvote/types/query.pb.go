...
func init() {
	proto.RegisterType((*QueryGetProposalRequest)(nil), "furyahub.furyahub.rvote.QueryGetProposalRequest")
	proto.RegisterType((*QueryGetProposalResponse)(nil), "furyahub.furyahub.rvote.QueryGetProposalResponse")
	proto.RegisterType((*QueryGetProposalLifeRequest)(nil), "furyahub.furyahub.rvote.QueryGetProposalLifeRequest")
	proto.RegisterType((*QueryGetProposalLifeResponse)(nil), "furyahub.furyahub.rvote.QueryGetProposalLifeResponse")
}
...
func (c *queryClient) GetProposal(ctx context.Context, in *QueryGetProposalRequest, opts ...grpc.CallOption) (*QueryGetProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyahub.furyahub.rvote.Query/GetProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetProposalLife(ctx context.Context, in *QueryGetProposalLifeRequest, opts ...grpc.CallOption) (*QueryGetProposalLifeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyahub.furyahub.rvote.Query/GetProposalLife", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyahub.furyahub.rvote.Query/GetProposal",
	}
...
func _Query_GetProposalLife_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyahub.furyahub.rvote.Query/GetProposalLife",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyahub.furyahub.rvote.Query",
