...
type Proposal struct {
	...
	Status      ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furya.furya.rvote.ProposalStatus" json:"status,omitempty" yaml:"prop_status"`
...
func init() {
	proto.RegisterEnum("furya.furya.rvote.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*Proposal)(nil), "furya.furya.rvote.Proposal")
}
