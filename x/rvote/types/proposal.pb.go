...
type Proposal struct {
	...
	Status      ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furyahub.furyahub.rvote.ProposalStatus" json:"status,omitempty" yaml:"prop_status"`
...
func init() {
	proto.RegisterEnum("furyahub.furyahub.rvote.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*Proposal)(nil), "furyahub.furyahub.rvote.Proposal")
}
