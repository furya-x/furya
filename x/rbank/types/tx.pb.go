...
func init() {
	proto.RegisterType((*MsgAddDenom)(nil), "furya.furya.rbank.MsgAddDenom")
	proto.RegisterType((*MsgAddDenomResponse)(nil), "furya.furya.rbank.MsgAddDenomResponse")
}
...
func (c *msgClient) AddDenom(ctx context.Context, in *MsgAddDenom, opts ...grpc.CallOption) (*MsgAddDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.furya.rbank.Msg/AddDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.furya.rbank.Msg/AddDenom",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.furya.rbank.Msg",
