...
func init() {
	proto.RegisterType((*MsgAddDenom)(nil), "katana.katana.rbank.MsgAddDenom")
	proto.RegisterType((*MsgAddDenomResponse)(nil), "katana.katana.rbank.MsgAddDenomResponse")
}
...
func (c *msgClient) AddDenom(ctx context.Context, in *MsgAddDenom, opts ...grpc.CallOption) (*MsgAddDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/katana.katana.rbank.Msg/AddDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/katana.katana.rbank.Msg/AddDenom",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "katana.katana.rbank.Msg",
