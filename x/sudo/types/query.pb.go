...
func init() {
	proto.RegisterType((*QueryAdminRequest)(nil), "katana.katana.sudo.QueryAdminRequest")
	proto.RegisterType((*QueryAdminResponse)(nil), "katana.katana.sudo.QueryAdminResponse")
}
...
func (c *queryClient) Admin(ctx context.Context, in *QueryAdminRequest, opts ...grpc.CallOption) (*QueryAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/katana.katana.sudo.Query/Admin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Admin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/katana.katana.sudo.Query/Admin",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "katana.katana.sudo.Query",
