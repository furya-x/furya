...
func init() {
	proto.RegisterType((*MsgAddRelayer)(nil), "furya.furya.relayers.MsgAddRelayer")
	proto.RegisterType((*MsgAddRelayerResponse)(nil), "furya.furya.relayers.MsgAddRelayerResponse")
	proto.RegisterType((*MsgDeleteRelayer)(nil), "furya.furya.relayers.MsgDeleteRelayer")
	proto.RegisterType((*MsgDeleteRelayerResponse)(nil), "furya.furya.relayers.MsgDeleteRelayerResponse")
	proto.RegisterType((*MsgSetThreshold)(nil), "furya.furya.relayers.MsgSetThreshold")
	proto.RegisterType((*MsgSetThresholdResponse)(nil), "furya.furya.relayers.MsgSetThresholdResponse")
}
...
func (c *msgClient) AddRelayer(ctx context.Context, in *MsgAddRelayer, opts ...grpc.CallOption) (*MsgAddRelayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.furya.relayers.Msg/AddRelayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteRelayer(ctx context.Context, in *MsgDeleteRelayer, opts ...grpc.CallOption) (*MsgDeleteRelayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.furya.relayers.Msg/DeleteRelayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetThreshold(ctx context.Context, in *MsgSetThreshold, opts ...grpc.CallOption) (*MsgSetThresholdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.furya.relayers.Msg/SetThreshold", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddRelayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.furya.relayers.Msg/AddRelayer",
	}
...
func _Msg_DeleteRelayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.furya.relayers.Msg/DeleteRelayer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetThreshold_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.furya.relayers.Msg/SetThreshold",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.furya.relayers.Msg",
