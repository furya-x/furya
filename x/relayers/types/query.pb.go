...
func init() {
	proto.RegisterType((*QueryRelayersRequest)(nil), "katana.katana.relayers.QueryRelayersRequest")
	proto.RegisterType((*QueryRelayersResponse)(nil), "katana.katana.relayers.QueryRelayersResponse")
	proto.RegisterType((*QueryThresholdRequest)(nil), "katana.katana.relayers.QueryThresholdRequest")
	proto.RegisterType((*QueryThresholdResponse)(nil), "katana.katana.relayers.QueryThresholdResponse")
}
...
func (c *queryClient) Relayers(ctx context.Context, in *QueryRelayersRequest, opts ...grpc.CallOption) (*QueryRelayersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/katana.katana.relayers.Query/Relayers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Threshold(ctx context.Context, in *QueryThresholdRequest, opts ...grpc.CallOption) (*QueryThresholdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/katana.katana.relayers.Query/Threshold", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Relayers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/katana.katana.relayers.Query/Relayers",
	}
...
func _Query_Threshold_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/katana.katana.relayers.Query/Threshold",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "katana.katana.relayers.Query",
